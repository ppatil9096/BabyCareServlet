...
public class BabyDao {
	...
	public static Connection getCon() {
		...
		try {
			...
			con = DriverManager.getConnection("jdbc:oracle:thin:@10.10.10.89:1521:live", "AURUSPAY", "AURUSPAY");
		} catch (Exception e) {
	...
	public static int save(Baby b) {
		...
		try {
			...
			PreparedStatement ps = con
					.prepareStatement("insert into babyname(id,name,meaning,sex,religion) values(BABY_SEQUENCE.nextval,?,?,?,?)");
